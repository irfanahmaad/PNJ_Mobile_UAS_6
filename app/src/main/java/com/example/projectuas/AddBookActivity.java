...
public class AddBookActivity extends AppCompatActivity implements View.OnClickListener {
    private EditText inputName, inputAuthor, inputDescription;
    private Button uploadGambar, btnSave;
    ...
    public void uploadMultipart() {
        ...
        try {
            ...
            new MultipartUploadRequest(this, uploadId, ConfigUtils.BASE_URL + "books")
                    .addFileToUpload(path, "image") //Adding file
                    .addParameter("name", name) //Adding text parameter to the request
                    .addParameter("author", author) //Adding text parameter to the request
...
//                imageView.setImageBitmap(bitmap);
                String result;
                if (getPath(filePath).lastIndexOf('/') != -1) {
                    result = getPath(filePath).substring(getPath(filePath).lastIndexOf('/') + 1);
                    textGambar.setText(result);
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
